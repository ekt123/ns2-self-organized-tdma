...
# steady state error prob.(Pe) = (1-k)Pg+(1-h)Pb
# 1-k is error prob. in good state
# 1-h is error prob. in bad state
# Pg is stationary state prob. (prob. that transmission will be in good state)
# Pb is prob. that transmission will be in bad state
# Pg = r/(p+r), Pb = p/(p+r)
# p is transition prob. from good state to bad state
# r is transition prob. from bad state to good state
# A = ({1-p p}{r 1-r}) is transition matrix
# parameters
# k=1,h=0.5
# p = 0.0014, r = 0.966013
# Pg = 0.9985528, Pb = 0.001447
        set good_state [new ErrorModel/Uniform 0.5 pkt]
        set bad_state  [new ErrorModel/Uniform 0.3 pkt]	
        ...
        set m_periods [list  0.9985528 0.001447]  ;# average value
...
$ns_ at 31.0 "$tdldata_(1) start"
$ns_ at 61.0 "$tdldata_(2) start"
$ns_ at 91.0 "$tdldata_(3) start"
$ns_ at 121.0 "$tdldata_(4) start"
$ns_ at 151.0 "$tdldata_(5) start"
$ns_ at 181.0 "$tdldata_(6) start"
$ns_ at 211.0 "$tdldata_(7) start"
$ns_ at 241.0 "$tdldata_(8) start"
$ns_ at 271.0 "$tdldata_(9) start"
$ns_ at 301.0 "$tdldata_(10) start"
$ns_ at 331.0 "$tdldata_(11) start"
$ns_ at 361.0 "$tdldata_(12) start"
$ns_ at 391.0 "$tdldata_(13) start"
$ns_ at 421.0 "$tdldata_(14) start"
$ns_ at 451.0 "$tdldata_(15) start"
