...
set val(x)		1000000			   ;# X dimension of topology

set val(y)		1000000			   ;# Y dimension of topology
...
Application/TdlDataApp set pktsize_ 4500
Application/TdlDataApp set msgType_ 1

#create transport agent
set tdludp_(0) [new Agent/UDP/TdlDataUDP]
$ns_ attach-agent $node_(0) $tdludp_(0)
#create transport sink
set sink_(0) [new Agent/UDP/TdlDataUDP]
$ns_ attach-agent $node_(0) $sink_(0)
#create application agent
set tdldata_(0) [new Application/TdlDataApp]
$tdldata_(0) attach-agent $tdludp_(0)
#create application sink
set sinkdata_(0) [new Application/TdlDataApp]
$sinkdata_(0) attach-agent $sink_(0)

Application/TdlDataApp set pktsize_ 1000
Application/TdlDataApp set msgType_ 2
#create transport agent
set tdludp_(3) [new Agent/UDP/TdlDataUDP]
$ns_ attach-agent $node_(3) $tdludp_(3)
#create transport sink
set sink_(3) [new Agent/UDP/TdlDataUDP]
$ns_ attach-agent $node_(3) $sink_(3)
#create application agent
set tdldata_(3) [new Application/TdlDataApp]
$tdldata_(3) attach-agent $tdludp_(3)
#create application sink
set sinkdata_(3) [new Application/TdlDataApp]
$sinkdata_(3) attach-agent $sink_(3)
...
for {set i 0} {$i < $active_node_ } {incr i} {
    ...
    $ns_ at 1000.1 "$node_($i) reset";

}

$ns_ at 1.0 "$tdldata_(0) start"
$ns_ at 1.0 "$tdldata_(3) start"
$ns_ at 8.0 "$tdldata_(1) start"
$ns_ at 15.0 "$tdldata_(2) start"


#create some movement
#$ns_ at 133.000000000000 "$node_(3) setdest 150000.0 150000.0 500.0"
$ns_ at 80.000000000000 "$node_(3) setdest 305000.0 100.0 1000.0"
$ns_ at 500.0 "$node_(3) setdest 5000.0 100.0 1000.0"
#$ns_ at 225.0 "$tdldata_(0) stop"
$ns_ at 1000.5 "puts \"stop...\" ;"
$ns_ at 1000.5 "stop"
$ns_ at 1000.5 "puts \"NS EXITING...\" ; $ns_ halt"
