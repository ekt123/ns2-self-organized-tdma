...
\"\n\
checkout_executable TCLSH \"/home/wpawgasa/thesis/ns-allinone-2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/wpawgasa/thesis/ns-allinone-2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
TdlData 	# TDL Data Message\n\
NetEntryMsg  	# TDL NET Entryh\n\
ControlMsg\n\
PollingMsg 	# TDL polling Message\n\
HdrNbInfo	# Neighbor Info header\n\
TdlMsgUpdate \n\
TdlNetUpdate\n\
} {\n\
...
Application/TdlDataApp set netID_ 1\n\
\n\
Agent/UDP/TdlDataUDP set packetSize_ 216\n\
\n\
\n\
Mac/FixTdma set max_slot_num_	200\n\
\n\
Mac/DynamicTdma set max_slot_num_	200\n\
Mac/DynamicTdma set assigned_Net_	1\n\
