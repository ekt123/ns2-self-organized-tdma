...
set ptype(aomdv) 61\n\
set pvals(61) AOMDV\n\
set ptype(tdl_data) 62\n\
set pvals(62) TDL_DATA\n\
set ptype(net_ent) 63\n\
set pvals(63) NET_ENT\n\
set ptype(tdl_control) 64\n\
set pvals(64) TDL_CONTROL\n\
set ptype(tdl_polling) 65\n\
set pvals(65) TDL_POLLING\n\
set ptype(tdl_msgupdate) 66\n\
set pvals(66) TDL_MSGUPDATE\n\
set ptype(tdl_netupdate) 67\n\
set pvals(67) TDL_NETUPDATE\n\
proc ptype2val {str} {\n\
global ptype\n\
